...
##### IZMENA - uradi i ROC procenu kvaliteta klasifikatora #####
println()

Rcurve1 = ROC.roc(dataPredictTestClass, dataTest.grupa, 1)
aucTest1 = AUC(Rcurve1)
# plot(Rcurve1, label = "ROC curve 1")
#println("AUC1: $aucTest1")

Rcurve2 = ROC.roc(dataPredictTestClass, dataTest.grupa, 2)
aucTest2 = AUC(Rcurve2)
# plot(Rcurve2, label = "ROC curve 2")
#println("AUC2: $aucTest2")

Rcurve3 = ROC.roc(dataPredictTestClass, dataTest.grupa, 3)
aucTest3 = AUC(Rcurve3)
# plot(Rcurve3, label = "ROC curve 3")
#println("AUC3: $aucTest3")

Rcurve4 = ROC.roc(dataPredictTestClass, dataTest.grupa, 4)
aucTest4 = AUC(Rcurve4)
# plot(Rcurve4, label = "ROC curve 4")
#println("AUC4: $aucTest4")

aucAvg = (aucTest1 + aucTest2 + aucTest3 + aucTest4) / 4
println("AUC - average: $(round(aucAvg; digits = 3))")
